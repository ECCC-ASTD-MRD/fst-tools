...
#include "indptr.cdk90"
      ...
      if (yinyang_grid) then
         ier = fstprm(yy_key, dateo, deet, npas, ni1, nj1, nk1, nbits, &
         ...
         ier = fstprm(ax_key, dateo, deet, npas, ni1, nj1, nk1, nbits, &
                      datyp, lip1, lip2, lip3, typvarx, nomx, etikx, &
                      grref, ig1ref, ig2ref, ig3ref, ig4ref, &
                      swa, lng, dltf, ubc, extra1, extra2, extra3)
         ier = fstprm(ay_key, dateo, deet, npas, ni2, nj2, nk2, nbits, &
