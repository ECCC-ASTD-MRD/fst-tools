...
!          pour ecrire
    ...
    external ecritur, fstinf, pgsmlir, fstprm, symetri
    external loupneg, loupsou, fstopc, pgsmabt, imprime, messags
    integer fstprm, fstinf, pgsmlir, fstopc
...
#include "gdz.cdk90"
    ...
    integer jp1, jp2, jp3, lilj, ni, nj, nk, nn, num1, num2, iopc
